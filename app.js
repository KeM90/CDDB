...
app.get("/", function(request, response) {
    ...
    const cdListe = [
        ...
        { id: 2, interpret: 'Verschiedene', titel: 'Jazz' },
        { id: 3, interpret: 'Verschiedene', titel: 'RnB' },
    ];
    //die Seite rendern
...
app.get("/loeschen/:id", function(request, response) {
    ...
    //die Seite rendern
    response.render("loeschen", {daten: row});
    });
});
...
const server = app.listen(8080,function () {
    console.log("Der Server läuft auf " + server.address().adress + ":" + server.address().port);
});